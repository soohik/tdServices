...
func (x *PhoneRegRequest) GetPhone() *Phone {
	if x != nil {
		return x.Phone
	}
	return nil
...
func (x *Phone) GetPhonecode() string {
	if x != nil {
		return x.Phonecode
	}
	return ""
...
func (x *PhoneRegResponse) Reset() {
	*x = PhoneRegResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_phoneservice_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PhoneRegResponse) Descriptor() ([]byte, []int) {
	return file_phoneservice_proto_rawDescGZIP(), []int{2}
}
...
var file_phoneservice_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x5b, 0x0a, 0x0c, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4b, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x50, 0x68, 0x6f, 0x6e,
	0x65, 0x12, 0x1d, 0x2e, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x2e, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1e, 0x2e, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e,
	0x50, 0x68, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x2f, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x73, 0x65, 0x72, 0x76,
...
var file_phoneservice_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_phoneservice_proto_goTypes = []interface{}{
	(*PhoneRegRequest)(nil),  // 0: phoneservice.PhoneRegRequest
	(*Phone)(nil),            // 1: phoneservice.Phone
	(*PhoneRegResponse)(nil), // 2: phoneservice.PhoneRegResponse
}
var file_phoneservice_proto_depIdxs = []int32{
	1, // 0: phoneservice.PhoneRegRequest.phone:type_name -> phoneservice.Phone
	0, // 1: phoneservice.PhoneService.RegPhone:input_type -> phoneservice.PhoneRegRequest
	2, // 2: phoneservice.PhoneService.RegPhone:output_type -> phoneservice.PhoneRegResponse
...
func file_phoneservice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_phoneservice_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
